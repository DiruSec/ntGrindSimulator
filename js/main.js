...
var simulator = {
    ...
    createLinkMessage: function(style,text){
        ...
        }).html('URL: <a href="'+location.origin + location.pathname +'?'+text+'">' + location.origin +location.pathname +'?'+text+ '</a>' +
...
simulator.data = {
    ...
    weaponRarity: {
        ...
        "r14": {name: "★14", basicExp: 200, sameCategory: 5, sameRarity: 100, sameWeapon: 205, cost:{meseta: 110000, lamgrinder: 1}, limit: "sphere"},
        getData: function(string){
            return this[string]
        }
    },
